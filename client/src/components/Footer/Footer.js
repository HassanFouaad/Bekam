          ...
          <div className="row">
            <div className="col-xs-12 col-sm-6 col-md-3">
              <div className="widget subscribe no-box">
                ...
                <p>About the Bekam, little discription will goes here.. </p>
              </div>
            </div>
            ...
            <div className="col-xs-12 col-sm-6 col-md-3">
              <div className="widget no-box">
                ...
                <p style={{ fontWeight: "800", fontSize: "40px" }}>
                  You Trade <br></br>
                  <span style={{ color: "#f48176" }}>We Handle</span>
                </p>
                {!isAuthenticated() && (
                  <a
                    className="btn"
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12 text-center">
              <p>Copyright Bekam © 2020. All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
